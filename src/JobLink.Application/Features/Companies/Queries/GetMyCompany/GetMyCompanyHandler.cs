...
public class GetMyCompanyHandler(ISqlConnectionFactory sqlConnectionFactory, ICurrentUser currentUser) : IRequestHandler<GetMyCompanyQuery, Result<CompanyProfileDto>>
{
